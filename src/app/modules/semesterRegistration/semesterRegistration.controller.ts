...
const insertIntoDB = catchAsync(async (req: Request, res: Response) => {
  ...
  sendResponse(res, {
    ...
    success: true,
    message: 'Created A Semester Successfully',
    data: result,
  });
});
...
const startMyRegistration = catchAsync(async (req: Request, res: Response) => {
  ...
  sendResponse(res, {
    statusCode: httpStatus.OK,
    success: true,
    message: 'Student SemesterRegistration Registered successfully',
    data: result,
  });
});
...
const enrollIntoCourse = catchAsync(async (req: Request, res: Response) => {
  ...
  sendResponse(res, {
    ...
    success: true,
    message:
      'Student SemesterRegistration Registration Course Enrolled successfully',
    data: result,
  });
});
...
const startNewSemester = catchAsync(async (req: Request, res: Response) => {
  ...
  sendResponse(res, {
    statusCode: httpStatus.OK,
    success: true,
    message: 'Start A New Semester Successfully',
    data: result,
  });
});
